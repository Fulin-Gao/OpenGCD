...
if __name__ == "__main__":
    parser = argparse.ArgumentParser(
            description='OpenGCD_cub',
            formatter_class=argparse.ArgumentDefaultsHelpFormatter)
    parser.add_argument('--batch_size', default=128, type=int)
    parser.add_argument('--num_workers', default=0, type=int)
    parser.add_argument('--max_K', default=350, type=int, help='Maximum number of categories acceptable')  # 500
    ...
    parser.add_argument('--k_means_init', type=int, default=4)
    ...
    parser.add_argument('--alpha', type=list, default=[1, 1, 1], help='Adjusting for uncertainty')
